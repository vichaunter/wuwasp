...
describe("Sequential Planning System", () => {
  describe("consumeMaterialsFromInventory", () => {
    ...
    it("should preserve materials not in requirements", () => {
      ...
      const requirements = [{ materialId: "lf-tidal-residuum", quantity: 50 }];
    ...
    it("should handle empty inventory", () => {
      ...
      const requirements = [{ materialId: "lf-tidal-residuum", quantity: 10 }];
  ...
  describe("Sequential consumption (real-world scenario)", () => {
    it("should correctly allocate materials for two characters in order", () => {
      ...
      const inventoryAfterChar1 = consumeMaterialsFromInventory(
        globalInventory,
        char1Requirements
      );
      ...
      const inventoryAfterChar2 = consumeMaterialsFromInventory(
        inventoryAfterChar1,
        char2Requirements
      );
