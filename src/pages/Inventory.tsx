...
export default function Inventory() {
  ...
  const overworldMaterials = materials.filter(
    (m) => m.category === "OVERWORLD"
  );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-100 mb-2">Inventario</h1>
        <p className="text-gray-400">Gestiona tus materiales disponibles</p>
      </div>
